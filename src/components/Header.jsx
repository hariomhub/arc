...
const Header = () => {
    ...
    return (
        <header style={{ backgroundColor: 'white', borderBottom: '1px solid #e2e8f0', position: 'sticky', top: 0, zIndex: 100 }}>
            ...
            >
                {/* Logo — nowrap so it never wraps to two lines */}
                <Link
                    to="/"
                    style={{
                        display: 'flex',
                ...
                >
                    ...
                    <span style={{ fontSize: '1.15rem', fontWeight: '700', color: 'var(--primary)', letterSpacing: '-0.3px' }}>
                        AI RISK COUNCIL
                    </span>
                </Link>

                {/* Desktop Nav — smaller text + tighter gaps to fit all items */}
                <nav
                    style={{ display: 'flex', gap: '20px', alignItems: 'center', justifySelf: 'center', flexWrap: 'nowrap' }}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexShrink: 0 }}>
                    {isLoggedIn ? (
                        <div style={{ position: 'relative' }}>
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '100px', padding: '0.35rem 0.6rem 0.35rem 0.4rem',
                            ...
                            >
                                <div style={{
                                    ...
                                    justifyContent: 'center', color: 'white', fontSize: '0.7rem', fontWeight: '700',
                                    flexShrink: 0,
                                }}>
                                    {user?.name?.charAt(0).toUpperCase()}
                                </div>
                                <span style={{ fontSize: '0.82rem', fontWeight: '600', color: 'var(--text-main)', maxWidth: '80px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                    {user?.name}
                                </span>
                                <span style={{
                                    fontSize: '0.6rem', fontWeight: '700', letterSpacing: '0.05em',
                                    background: roleStyle.bg, color: 'white',
                                    padding: '0.12rem 0.45rem', borderRadius: '100px', textTransform: 'uppercase',
                                    flexShrink: 0,
                                }}>
                                    {roleStyle.label}
                                </span>
                                ...
                                <div style={{
                                    ...
                                    {isAdmin && (
                                        <Link
                                            ...
                                            style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.65rem 1rem', color: 'var(--text-secondary)', fontSize: '0.875rem', fontWeight: '500', textDecoration: 'none' }}
                                        >
                                            <Shield size={14} /> Manage Resources
                                        </Link>
                        ...
                        <Button to="/membership" variant="primary">Signin/Login</Button>
                    )}
            ...
            {mobileOpen && (
                <div style={{
                    borderTop: '1px solid var(--border-light)', backgroundColor: 'white',
                    ...
                    <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
                        ...
                        {!isLoggedIn && (
                            <Button to="/membership" variant="primary" style={{ marginTop: '1rem' }} onClick={() => setMobileOpen(false)}>
                                Join Council
                            </Button>
                        )}
                        {isLoggedIn && (
                            <button
                                ...
                                style={{
                                    marginTop: '1rem', padding: '0.75rem', background: 'none',
